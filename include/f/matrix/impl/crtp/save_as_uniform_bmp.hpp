#ifndef QJURUYCEYMPOSEMRPELIXFDKVRKKASYDUETGHELOGASNOHFSLDLBBDANNPWNQXRJGOUFPEMVS
#define QJURUYCEYMPOSEMRPELIXFDKVRKKASYDUETGHELOGASNOHFSLDLBBDANNPWNQXRJGOUFPEMVS
...
namespace f
{
    namespace crtp_save_as_uniform_bmp_private
    {
        ...
        struct crtp_save_as_uniform_bmp_data
        {
            ...
            crtp_save_as_uniform_bmp_data( unsigned long r, unsigned long c, T v ) : row( r ), col( c ), value( v ) {}
        };
...
#endif//QJURUYCEYMPOSEMRPELIXFDKVRKKASYDUETGHELOGASNOHFSLDLBBDANNPWNQXRJGOUFPEMVS
