...
#include <f/lhs/impl/crtp/typedef.hpp>
#include <f/lhs/impl/crtp/expression.hpp>

namespace f
{
    template<typename L_Expression, typename R_Expression, typename Type, std::size_t Default, typename Allocator>
    struct crtp_plus_expression : public crtp_expression< crtp_plus_expression<L_Expression, R_Expression, Type, Default, Allocator>, Type, Default, Allocator >
    {
    ...
    struct crtp_plus_operator
    {
        ...
        friend crtp_plus_expression<L_Expression, R_Expression, Type, Default, Allocator>  const operator + ( const L_Expression& l, const R_Expression& r ) 
        {
            return  crtp_plus_expression<L_Expression, R_Expression, Type, Default, Allocator>( l, r );  
        }
    };
