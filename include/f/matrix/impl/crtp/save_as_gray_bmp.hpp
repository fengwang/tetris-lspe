#ifndef BNKMUOHYPTRDEGTDGBECDWCBWVPKQQEYBGXQEPHKNHTXECMKYDFUWXQCMENEJRREGKJGBQPVC
#define BNKMUOHYPTRDEGTDGBECDWCBWVPKQQEYBGXQEPHKNHTXECMKYDFUWXQCMENEJRREGKJGBQPVC
...
namespace f
{
    ...
    struct crtp_save_as_gray_bmp
    {
        ...
        bool save_as_gray_bmp( const std::string& file_name ) const
        {
            ...
            auto const& db_to_ul = []( double val, double ac, double dc ){ return static_cast<unsigned long>( std::floor( ( static_cast<double>(256) + 0.9 ) * (val*ac+dc) ) ); };
...
#endif//BNKMUOHYPTRDEGTDGBECDWCBWVPKQQEYBGXQEPHKNHTXECMKYDFUWXQCMENEJRREGKJGBQPVC
