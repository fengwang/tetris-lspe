#ifndef MMATRIX_VALUE_MINUS_EXPRESSION_INCLUDED_DSPOISDAFLKJFD0LJFDASLKJSDSFDJIO
#define MMATRIX_VALUE_MINUS_EXPRESSION_INCLUDED_DSPOISDAFLKJFD0LJFDASLKJSDSFDJIO 
...
namespace f
{
    ...
    struct crtp_matrix_value_minus_expression : matrix_expression< crtp_matrix_value_minus_expression<Expression, Type> >
    {
        ...
        crtp_matrix_value_minus_expression( Expression const& expression_, Type const& value_ ) : expression(expression_), value(value_)
        {}
...
#endif//_MATRIX_VALUE_MINUS_EXPRESSION_INCLUDED_DSPOISDAFLKJFD0LJFDASLKJSDSFDJIO 
