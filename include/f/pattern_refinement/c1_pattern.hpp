#ifndef OJLKKFSDPBFTEETRLJMXCMNSGVHIQXPOTWIRELAVFNJABUNFEINVFNJAOOCRAGCSUQJDCYDGE
#define OJLKKFSDPBFTEETRLJMXCMNSGVHIQXPOTWIRELAVFNJABUNFEINVFNJAOOCRAGCSUQJDCYDGE
...
namespace f
{
    ...
    struct c1_pattern : cpu_space_pattern
    {
        ...
        value_type make_square_difference( value_type* abs_ug, pattern_refinement_configuration const& config )
        {
            ...
            return std::inner_product( differential_intensity.begin(), differential_intensity.end(), differential_intensity.begin(), 0.0 );
        }
...
#endif//OJLKKFSDPBFTEETRLJMXCMNSGVHIQXPOTWIRELAVFNJABUNFEINVFNJAOOCRAGCSUQJDCYDGE
