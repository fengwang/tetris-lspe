#ifndef MOSCILLATE_FUNCTION_HPP_INCLUDED_DFS98Y4KLJHASFDKNV98Y4KLASJFDVCNMKJDSFF
#define MOSCILLATE_FUNCTION_HPP_INCLUDED_DFS98Y4KLJHASFDKNV98Y4KLASJFDVCNMKJDSFF

#include <f/template/type_at.hpp>
#include <f/template/print_value.hpp>
