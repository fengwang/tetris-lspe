...
*/
#ifndef MHYPERGEOMETRIC_HPP_INCLUDED_SODFIJ4OU89ASFLKJ4U89AFSKLIJH48YASFLIU498UYFDKLJ
#define MHYPERGEOMETRIC_HPP_INCLUDED_SODFIJ4OU89ASFLKJ4U89AFSKLIJH48YASFLIU498UYFDKLJ
...
namespace f
{
    ...
    struct hypergeometric
    {
        ...
        explicit hypergeometric( size_type n1 = 1, size_type n2 = 0, size_type k = 1 , seed_type s = 0 )
                : n1_( n1 ), n2_( n2 ), k_( k ), e_( singleton<engine_type>::instance() ) 
        {
            e_.reset_seed( s );
        }
