...
*/
#ifndef MWARING_HPP_INCLUDEDSDIUH4LKJASFSDJKSLKJINTOTHESEARHAHHAOSIDJASDFKLJ48UASDFLK498AUSFDLKU43OIUJSFLKJASFDLKJSAF
#define MWARING_HPP_INCLUDEDSDIUH4LKJASFSDJKSLKJINTOTHESEARHAHHAOSIDJASDFKLJ48UASDFLK498AUSFDLKU43OIUJSFLKJASFDLKJSAF 
...
namespace f
{
    ...
    protected:
        return_type
        do_generation( const value_type a, const value_type b ) const
        {
    ...
    private:
        return_type
        direct_impl( const value_type a, const value_type b ) const
        {
