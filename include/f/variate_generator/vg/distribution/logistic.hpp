...
*/
#ifndef MLOGISTIC_HPP_INCLUDED_SDOIU4398YASFKLJH3498YAFSDOIU34UIOAHSFDKLMNSFDKJH3IUHASFDAFLKJ
#define MLOGISTIC_HPP_INCLUDED_SDOIU4398YASFKLJH3498YAFSDOIU34UIOAHSFDKLMNSFDKJH3IUHASFDAFLKJ 
...
namespace f
{
    ...
    struct logistic : private beta<Return_Type, Engine>
    {
            ...
            explicit logistic(	const return_type a = 1, const return_type b = 1, const seed_type sd = 0 )
                : a_( a ), b_(b), e_( sd )
            {
                assert( a > 0 );
                assert( b > 0 );
        ...
        private:
            return_type
            beta_impl( const final_type A, const final_type B ) const
            {
