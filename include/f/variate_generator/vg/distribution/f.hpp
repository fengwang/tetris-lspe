...
*/
#ifndef MF_HPP_INCLUDED_SOIFJ34LIJAFSPOIJ4398AFSOHSOIJ4LKJASFLKJ3LKJASFDLKJ3IFAK
#define MF_HPP_INCLUDED_SOIFJ34LIJAFSPOIJ4398AFSOHSOIJ4LKJASFLKJ3LKJASFDLKJ3IFAK
...
namespace f
{
    ...
    struct f :  private gamma<Return_Type, Engine>
    {
        ...
        protected:
            return_type
            do_generation( const return_type mu1, const return_type mu2 ) const
            {
        ...
        private:
            return_type
            direct_impl( const return_type mu1, const return_type mu2 ) const 
            {
