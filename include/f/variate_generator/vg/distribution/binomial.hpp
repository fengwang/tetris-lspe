...
namespace f
{
    ...
    struct binomial : private beta<typename Engine::final_type, Engine>
    {
        ...
        private:
            ...
            {
                const final_type p  = P > final_type(0.5) ? final_type(1) - P : P;
                const final_type q  = -std::log( final_type(1.0) - p );
                return_type ans     = 0;
                final_type sum      = 0;
                ...
                for ( ;; )
                {
                    ...
                    sum += e / ( final_type(N) - final_type(ans) );
                ...
                return p_ > final_type(0.5) ? final_type(N) - final_type(ans) : final_type(ans);
