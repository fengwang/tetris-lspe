...
*/
#ifndef MSKEWNESS_HPP_INCLUDED_SDOASOSFDPOIHJ498YUASFKLJH439YAFLKHFASYUH498Y98YA
#define MSKEWNESS_HPP_INCLUDED_SDOASOSFDPOIHJ498YUASFKLJH439YAFLKHFASYUH498Y98YA

#include <f/variate_generator/vg/utility/mean.hpp>
#include <f/variate_generator/vg/utility/variance.hpp>
...
namespace f 
{
    ...
    skewness( Input_Iterator first, Input_Iterator last ) 
    {
