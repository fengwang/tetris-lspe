#ifndef MTREE_HPP_INCLUDED_DFJIANFDLKJNASDLJK34UH9AFKLJ239UHSAFKLJSAFMKBNVNMKBAK
#define MTREE_HPP_INCLUDED_DFJIANFDLKJNASDLJK34UH9AFKLJ239UHSAFKLJSAFMKBNVNMKBAK
...
namespace f
{
    ...
    namespace tree_private
    {
        ...
        struct tree_node_
        {
            ...
            typedef tree_node_ self_type;
            typedef self_type* self_pointer;

            tree_node_() : parent( 0 ), first_child( 0 ), last_child( 0 ), prev_sibling( 0 ), next_sibling( 0 ) {}
            tree_node_( const value_type& val ) : parent( 0 ), first_child( 0 ), last_child( 0 ), prev_sibling( 0 ), next_sibling( 0 ), data( val ) { }

            tree_node_( const self_type& ) = default;
            tree_node_( self_type&& ) = default;
            self_type& operator = ( const self_type& ) = default;
            self_type& operator = ( self_type&& ) = default;

            self_pointer parent;
            self_pointer first_child;
            self_pointer last_child;
            self_pointer prev_sibling;
            self_pointer next_sibling;
            value_type data;
        };

    }//namespace tree_private

    template <class T, class tree_node_allocator = std::allocator<tree_private::tree_node_<T> > >
    struct tree
    {
        typedef T value_type;
        typedef tree_private::tree_node_<value_type> tree_node;
        ...
        struct pre_order_iterator : public iterator_base
        {
            pre_order_iterator();
        ...
        struct post_order_iterator : public iterator_base
        {
            post_order_iterator();
        ...
        struct breadth_first_queued_iterator : public iterator_base
        {
        ...
        struct fixed_depth_iterator : public iterator_base
        {
        ...
        struct sibling_iterator : public iterator_base
        {
            sibling_iterator();
        ...
        struct leaf_iterator : public iterator_base
        {
            leaf_iterator();
        ...
        struct compare_nodes
        {
            ...
            bool operator()( const tree_node* a, const tree_node* b ) { return comp_( a->data, b->data ); }
    ...
    void tree<T, tree_node_allocator>::head_initialise_()
    {
        ...
        alloc_.construct( head, tree_private::tree_node_<T>() );
        alloc_.construct( feet, tree_private::tree_node_<T>() );
        head->parent = 0;
        head->first_child = 0;
        head->last_child = 0;
        head->prev_sibling = 0;
    ...
    iter tree<T, tree_node_allocator>::append_child( iter position )
    {
        ...
        alloc_.construct( tmp, tree_private::tree_node_<T>() );
        tmp->first_child = 0;
        tmp->last_child = 0;
...
lower:
    ...
    template <class T, class tree_node_allocator>
    tree<T, tree_node_allocator>::leaf_iterator::leaf_iterator( tree_node* tn, tree_node* top ) : iterator_base( tn ), top_node( top ) { }

    template <class T, class tree_node_allocator>
    tree<T, tree_node_allocator>::leaf_iterator::leaf_iterator( const iterator_base& other ) : iterator_base( other.node ), top_node( 0 ) { }
...
#endif//_TREE_HPP_INCLUDED_DFJIANFDLKJNASDLJK34UH9AFKLJ239UHSAFKLJSAFMKBNVNMKBAK
