#ifndef MTUPLE_HPP_INCLUDED_DSOPINASDLFKJ49HUASDLKJN3O2UIHASFKDLJHO3IHUASKFJHFEF
#define MTUPLE_HPP_INCLUDED_DSOPINASDLFKJ49HUASDLKJN3O2UIHASFKDLJHO3IHUASKFJHFEF
...
namespace migl2
{
    ...
    namespace detail
    {
        ...
        template <size_t I_, typename ValueType_, bool IsEmpty_ = is_empty<ValueType_>::value >
        class TupleLeaf;
        ...
        class TupleLeaf
        {
            ...
            public:
                TupleLeaf() : value_()
                {
                    static_assert( !is_reference<ValueType_>::value, "Attempt to default construct a reference element in a tuple" );
                }

                TupleLeaf( const TupleLeaf& t ) : value_( t.get() )
                {
                    static_assert( !is_rvalue_reference<ValueType_>::value, "Can not copy a tuple with rvalue reference member" );
                }

                template <typename T, typename = typename enable_if< is_constructible<ValueType_, T>::value>::type>
                    ...
                    static_assert( !is_reference<ValueType_>::value ||
                                   ( is_lvalue_reference<ValueType_>::value &&
                                     ( is_lvalue_reference<T>::value ||
                                       is_same<typename remove_reference<T>::type, reference_wrapper< typename remove_reference<ValueType_>::type > >::value ) ) ||
                                   ( is_rvalue_reference<ValueType_>::value && !is_lvalue_reference<T>::value ),
        ...
        {
            typedef typename MakeTupleIndexesImpl < Start_ + 1, TupleIndexes<Indexes_..., Start_>, End_ >::type type;
        };
        ...
        struct TupleSize : public tuple_size<T_>
        { };
        ...
        template <typename... Ts_>
        struct TupleSize<TupleTypes<Ts_...>> : public integral_constant<size_t, sizeof...( Ts_ )> { };

        template <typename... Ts_>
        struct TupleSize<Tuple<Ts_...>> : public integral_constant<size_t, sizeof...( Ts_ )> { };
        ...
        template <typename Tuple_, size_t End_ = TupleSize<typename remove_reference<Tuple_>::type>::value, size_t Start_ = 0>
        ...
        struct TupleImpl<TupleIndexes<Indexes_...>, Ts_...> : public TupleLeaf<Indexes_, Ts_>...
        {
...
#endif//_TUPLE_HPP_INCLUDED_DSOPINASDLFKJ49HUASDLKJN3O2UIHASFKDLJHO3IHUASKFJHFEF 
