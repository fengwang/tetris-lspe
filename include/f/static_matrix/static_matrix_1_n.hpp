#ifndef MSTATIC_MATRIX_1_N_HPP_INCLUDED
#define	MSTATIC_MATRIX_1_N_HPP_INCLUDED

#include <f/static_matrix/static_matrix_buffer.hpp>
#include <f/static_matrix/static_matrix_stride_iterator.hpp>
#include <f/static_matrix/static_check.hpp>
