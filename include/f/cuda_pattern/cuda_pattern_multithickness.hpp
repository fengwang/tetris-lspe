#ifndef WDIMDLOTLWFUNSJLMKSVVDEUOAVJGAHCDYWHTEJTQCOXABWCJEDCKKOUAJPURJJQFCFPRIOJB
#define WDIMDLOTLWFUNSJLMKSVVDEUOAVJGAHCDYWHTEJTQCOXABWCJEDCKKOUAJPURJJQFCFPRIOJB
...
namespace f
{
    ...
    struct cuda_pattern
    {
        ...
        cuda_pattern_data_multithickness    data;
    ...
    private:
        ...
        void import( pattern<value_type> const& pat )
        {
            ...
            //import thickness
            double thickness = std::real(pat.thickness);
            std::fill_n( data.host_thickness.begin(), data.host_thickness.end(), thickness );
            cuda_assert( cudaMemcpy( reinterpret_cast<void*>(data.thickness), reinterpret_cast<const void*>(data.host_thickness.data()), sizeof(value_type) * config.tilt_size, cudaMemcpyHostToDevice ) );
        }
...
#endif//WDIMDLOTLWFUNSJLMKSVVDEUOAVJGAHCDYWHTEJTQCOXABWCJEDCKKOUAJPURJJQFCFPRIOJB
